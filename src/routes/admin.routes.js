...
router.post("/listings", upload.array("images", 5), verifyPanelAccess(["admin", "manager"]), createRoom);
...
router.delete("/listings/:id", verifyPanelAccess(["admin", "manager"]), deleteListing);
